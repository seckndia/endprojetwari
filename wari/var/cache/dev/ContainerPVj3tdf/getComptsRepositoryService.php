...
// Returns the private 'App\Repository\ComptsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ComptsRepository.php';

return $this->privates['App\\Repository\\ComptsRepository'] = new \App\Repository\ComptsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
