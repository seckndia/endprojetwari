...
// Returns the private 'App\Repository\DepotsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/DepotsRepository.php';

return $this->privates['App\\Repository\\DepotsRepository'] = new \App\Repository\DepotsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
